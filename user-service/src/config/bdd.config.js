...
exports.dbConnect = () => {
    if (process.env.NODE_ENV === 'production') {
        ...
        console.log("PG_URI_PRD_DATABASE=> ", PG_URI_PRD_DATABASE);
        ...
        const database = process.env.NODE_ENV === 'dev' ? process.env.POSTGRES_DB : process.env.POSTGRES_DB;
        const PG_DATABASE = `postgres://${process.env.POSTGRES_USER}:${process.env.POSTGRES_PASSWORD}@${process.env.POSTGRES_HOST}:${process.env.POSTGRES_PORT}/${database}`;
